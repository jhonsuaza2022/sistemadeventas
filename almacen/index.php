                                   ...
                                   foreach ($productos_datos as $productos_dato){
                                       ...
                                       <tr>
                                           ...
                                           if($stock_actual < $stock_minimo){ ?>
                                               <td style="background-color: #f81714"><center><?php echo $productos_dato['stock'];?></center></td>
                                           <?php
                                           }
                                           else if($stock_actual > $stock_maximo){ ?>
                                               <td style="background-color: #27fb20"><center><?php echo $productos_dato['stock'];?></center></td>
                                           <?php
                                           }else{ ?>
